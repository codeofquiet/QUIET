...
#        self.a_max_sent_length = a_max_sent_length
        ...
        #########################打印输出
        print("experiment/qnn/dataset/qa/data_reader.py def optCallback(self,opt) --opt.max_sequence_length  ----opt.alphabet ----opt.embedding_size   ----opt.lookup_table")
        print(opt.max_sequence_length)
        print(len(opt.alphabet))
        print(opt.embedding_size)
        print(len(opt.lookup_table[0]))
        #########################
