...
#         print('qnn/dataset/classification/data_reader.py train_test_val[train]')
#         print(len(training_data))
#          print(type(training_data['X']))
#         print(len(training_data['X'][0][-1]))
#所有的不是一样的长度，有的长，有的短，最短的是1 
        ...
        train_x, train_y = data_gen(training_data, self.max_sentence_length)###qnn/dataset/classification/data.py def data_gen
        ###把data扩充称为56维的向量，空位补零
...
#         print('qnn/dataset/classification/data_reader.py train_x')
#         print(len(train_x))
#         print(len(train_x[0]))
        ...
        with io.open(fpath, 'r', encoding='utf-8') as f:
            for line in f:
                if self.nclasses == 2:
                    ...
                    ####sst_data['X'] --是语句且分为单词的列表
                    ####sst_data['y'] --是1 或 0
                    
#                     print(int(sample[1]))
#                     print(sample[0].split())
