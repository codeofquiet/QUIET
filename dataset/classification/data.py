...
def load_complex_embedding(embedding_dir):
    ...
    print("qnn/dataset/classification/data.py load_complex_embedding phase_embedding.shape amplitude_embedding.shape len(word2id)")
...
def get_lookup_table(embedding_params):
    ...
    ############
    print('something about lookup_table')
    print(type(lookup_table))
    print(lookup_table.shape)
    print('\n')
    ############
    
    ###将每个词的位置对应的元素设置为每个词的词向量
    return(lookup_table)
...
#     print(np.asarray(padded_sentences))
#     print('\n\n\n\n\n\n\n\n\n\n')
#     print(np.transpose(np.asarray(labels)))
